          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 mb-20">
            <div>
              ...
              <p className="mb-5 text-lg text-kown-s-900">
                ...
                markets and build on unique possibilities. Under the leadership
                of one of the most adept investors in Qatar, Kown Capital’s
                dynamically experienced team invest in projects with high return
                potential across all sectors including: manufacturing,
                education, healthcare, real estate, agricultural, fast-moving
                consumer goods (FMCG), and construction.
              </p>
              <p className="text-lg text-kown-s-900">
                The firm’s long-term objective is to build enterprises in
                various industries and achieve vertical integration amongst its
                subsidiaries and affiliates, while continuing to increase
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 ">
            ...
            <div className="w-full">
              <p className="mb-5 text-4xl leading-10 font-extralight text-kown-s-900">
                ...
                environment and communities, we aim to build long-term value for
                our shareholders while making a meaningful difference in the
                world.
              </p>
            </div>
          </div>
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-10">
              ...
              <div className="">
                ...
                <p>
                  We will commit ourselves to the success of our company, to the
                  pursuit of excellence, to the growth of our employees, and to
                  providing an industry-leading quality service to our
                  stakeholders.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 mb-20">
            ...
            <div>
              ...
              <p className="mb-5 text-lg text-kown-s-900">
                ...
                Capital furnishes and sustains a large portfolio of products and
                services. Our portfolio is built based on well-researched and
                meticulous investment calls. The root of Kown Capital’s
                resilience is its determination to continually operate from its
                fundamental mission, seizing opportunities in real-time and
                fostering success for individuals inside the business,
